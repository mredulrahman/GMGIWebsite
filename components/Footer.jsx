          ...
          <div className="bg-[#2D2F44] w-full min-h-16 px-6 md:px-14 py-4 flex flex-col-reverse gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex gap-2 justify-center md:justify-end">
                <a href="https://www.facebook.com/GroupMappers" target="_blank">
                  <FontAwesomeIcon icon={faFacebookF} className="text-md hover:text-white rounded-full hover:bg-sky-900 p-2 bg-[#A0A5C0] transition duration-400" />
                </a>
                <a href="https://twitter.com/GroupMappers" target="_blank">
                  <FontAwesomeIcon icon={faXTwitter} className="text-md hover:text-white rounded-full hover:bg-black p-2 bg-[#A0A5C0] transition duration-400" />
                </a>
                <a href="https://www.linkedin.com/company/groupmappers/" target="_blank">
                  <FontAwesomeIcon icon={faLinkedinIn} className="text-md hover:text-white rounded-full hover:bg-sky-600 p-2 bg-[#A0A5C0] transition duration-400" />
                </a>
                <a href="https://www.youtube.com/@groupmappers539" target="_blank">
                  <FontAwesomeIcon icon={faYoutube} className="text-md hover:text-white rounded-full hover:bg-red-700 p-2 bg-[#A0A5C0] transition duration-400" />
                </a>
            </div>
          </div>
          </>
